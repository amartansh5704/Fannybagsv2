...
export default function FanSignup() {
  ...
  const inputStyle = (fieldName: string): React.CSSProperties => ({
    ...
    boxShadow: focused === fieldName
      ? '0 0 0 3px rgba(236,72,153,0.08), 0 4px 16px rgba(236,72,153,0.08)'
      : 'none',
  })
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Main */}
        <div className="signup-scroll" style={{
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '32px' }}>
              <div style={{ position: 'relative', display: 'inline-block', marginBottom: '20px' }}>
                ...
                <div style={{
                  ...
                  borderRadius: '24px', filter: 'blur(12px)',
                }} />
                <div style={{
                  position: 'relative', width: '56px', height: '56px', borderRadius: '18px',
              ...
              <h1 style={{
                fontSize: '26px', fontWeight: 800, margin: '0 0 6px 0',
                background: 'linear-gradient(135deg, #ffffff 0%, #a1a1aa 100%)',
                WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
                letterSpacing: '-0.02em',
              }}>Create Fan Account</h1>
              <p style={{ fontSize: '14px', color: '#52525b', margin: 0, fontWeight: 500 }}>
                Back artists. Earn royalties. 🎵
              </p>
            </div>
              ...
              <form onSubmit={submit} style={{ position: 'relative' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                    ...
                    <div>
                      <label style={labelStyle('phone')}>Phone <span style={{ color: '#3f3f46' }}>(opt)</span></label>
                      <input
                        type="tel"
                        value={form.phone}
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          color: hovered === 'eye' ? '#f472b6' : '#52525b',
                    ...
                    {form.password.length > 0 && (
                      <div style={{ marginTop: '10px' }}>
                        ...
                        <p style={{
                          ...
                          color: form.password.length >= 8 ? '#f472b6' : '#fbbf24',
                          fontWeight: 500,
                        }}>
                  ...
                  <div>
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              fontSize: '12px',
                              fontWeight: 600,
                              border: `1px solid ${selected ? 'rgba(236,72,153,0.4)' : hovered === `int-${i}` ? 'rgba(255,255,255,0.15)' : 'rgba(255,255,255,0.06)'}`,
                              background: selected
                                ? 'linear-gradient(135deg, rgba(236,72,153,0.15), rgba(168,85,247,0.1))'
                                : hovered === `int-${i}`
                                  ? 'rgba(255,255,255,0.05)'
                                  : 'rgba(255,255,255,0.02)',
                              color: selected ? '#f472b6' : '#a1a1aa',
                              cursor: 'pointer',
                              transition: 'all 0.25s cubic-bezier(0.4,0,0.2,1)',
                              fontFamily: 'inherit',
                              transform: hovered === `int-${i}` ? 'translateY(-1px)' : 'translateY(0)',
                              boxShadow: selected ? '0 2px 12px rgba(236,72,153,0.1)' : 'none',
                            }}
                          >
                            {selected && '✓ '}{i}
                          </button>
                    ...
                    {form.investmentInterests.length > 0 && (
                      <p style={{ fontSize: '11px', color: '#f472b6', marginTop: '10px', fontWeight: 600 }}>
                        🎧 {form.investmentInterests.length} genre{form.investmentInterests.length > 1 ? 's' : ''} selected
                      </p>
                    )}
                  </div>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: !loading && hovered === 'submit'
                        ...
                        : loading ? 'none' : '0 4px 20px rgba(236,72,153,0.2)',
                      overflow: 'hidden',
                      marginTop: '4px',
                    }}
                  >
                    {!loading && hovered === 'submit' && (
                      <div style={{
                        position: 'absolute', inset: 0,
                    ...
                    {loading ? (
                      ...
                      <span style={{ position: 'relative' }}>Create Fan Account ✓</span>
                    )}
                  </button>
                </div>
              </form>
            ...
            <div style={{ textAlign: 'center', marginTop: '24px', animation: 'fadeInUp 0.8s ease-out' }}>
              <p style={{ fontSize: '13px', color: '#3f3f46', margin: 0, fontWeight: 500 }}>
                ...
                <Link
                  ...
                  onMouseLeave={() => setHovered(null)}
                  style={{
                    color: hovered === 'login' ? '#f9a8d4' : '#f472b6',
                    textDecoration: 'none', fontWeight: 600,
                    borderBottom: `1px solid ${hovered === 'login' ? 'rgba(249,168,212,0.4)' : 'transparent'}`,
                    paddingBottom: '1px',
            ...
            <div style={{
              ...
              {[
                { icon: '🔒', text: 'Secure' },
                { icon: '🎵', text: 'Music First' },
                { icon: '💰', text: 'Earn Royalties' },
              ].map((badge, i) => (
                <div key={i} style={{
