          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '36px' }}>
              ...
              <p style={{ fontSize: '14px', color: '#52525b', margin: 0, fontWeight: 500 }}>
                Sign in to back artists & earn royalties 🎵
              </p>
            </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <div>
                    <label style={{
                      ...
                      textTransform: 'uppercase', letterSpacing: '0.1em',
                      color: focused === 'email' ? '#f472b6' : '#52525b',
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          border: `1px solid ${focused === 'email' ? 'rgba(236,72,153,0.5)' : 'rgba(255,255,255,0.07)'}`,
                          borderRadius: '14px', padding: '14px 16px',
                          color: '#fff', fontSize: '14px', outline: 'none',
                          transition: 'all 0.3s cubic-bezier(0.4,0,0.2,1)',
                          fontFamily: 'inherit', boxSizing: 'border-box' as const,
                          boxShadow: focused === 'email'
                            ? '0 0 0 3px rgba(236,72,153,0.08), 0 4px 16px rgba(236,72,153,0.1)'
                            : 'none',
                        }}
                      />
                    </div>
                  ...
                  <div>
                    <label style={{
                      display: 'block', fontSize: '11px', fontWeight: 600,
                      textTransform: 'uppercase', letterSpacing: '0.1em',
                      color: focused === 'password' ? '#f472b6' : '#52525b',
                      marginBottom: '8px', transition: 'color 0.3s ease',
                    }}>
                      Password
                    </label>
                    <div style={{ position: 'relative' }}>
                      ...
                      <input
                        ...
                        style={{
                          position: 'relative', width: '100%',
                          background: focused === 'password' ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.03)',
                          border: `1px solid ${focused === 'password' ? 'rgba(236,72,153,0.5)' : 'rgba(255,255,255,0.07)'}`,
                          borderRadius: '14px', padding: '14px 48px 14px 16px',
                          color: '#fff', fontSize: '14px', outline: 'none',
                          transition: 'all 0.3s cubic-bezier(0.4,0,0.2,1)',
                          fontFamily: 'inherit', boxSizing: 'border-box' as const,
            ...
            <div style={{ textAlign: 'center', marginTop: '24px', animation: 'fadeInUp 0.8s ease-out' }}>
              <p style={{ fontSize: '13px', color: '#3f3f46', margin: 0, fontWeight: 500 }}>
                ...
                <Link
                  ...
                  onMouseLeave={() => setHovered(null)}
                  style={{
                    color: hovered === 'signup' ? '#f9a8d4' : '#f472b6',
                    textDecoration: 'none', fontWeight: 600,
                    borderBottom: `1px solid ${hovered === 'signup' ? 'rgba(249,168,212,0.4)' : 'transparent'}`,
                    paddingBottom: '1px',
