...
export default function FanDiscoverPage() {
  ...
  if (status === 'loading' || loading) {
    return (
      <FanLayout>
        <style jsx global>{`
          @keyframes fanDiscoverFloatOrb {
            0%, 100% { transform: translateY(0px) scale(1); }
            50% { transform: translateY(-20px) scale(1.05); }
          }
          @keyframes fanDiscoverSpin {
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: '50%', animation: 'fanDiscoverFloatOrb 4s ease-in-out infinite',
          }} />
          <Loader2 style={{
            animation: 'fanDiscoverSpin 1s linear infinite',
            color: '#f472b6', width: '36px', height: '36px',
            position: 'relative', zIndex: 1,
          }} />
          <p style={{
            marginTop: '16px', color: '#52525b', fontSize: '14px',
  ...
  return (
    <FanLayout>
      <style jsx global>{`
        ...
        @keyframes fanDiscoverFloatOrb2 {
          0%, 100% { transform: translateY(0px) scale(1); }
          50% { transform: translateY(-15px) scale(1.03); }
        }
        @keyframes fanDiscoverFloatOrb3 {
          0%, 100% { transform: translate(0, 0) scale(1); }
          40% { transform: translate(20px, 25px) scale(1.03); }
          80% { transform: translate(-15px, -10px) scale(0.97); }
        }
        @keyframes fanDiscoverFadeInDown {
          from { opacity: 0; transform: translateY(-12px); }
          to { opacity: 1; transform: translateY(0); }
        }
        @keyframes fanDiscoverFadeInUp {
          from { opacity: 0; transform: translateY(20px); }
          to { opacity: 1; transform: translateY(0); }
        }
        @keyframes fanDiscoverFadeInStagger {
          from { opacity: 0; transform: translateY(16px) scale(0.98); }
          to { opacity: 1; transform: translateY(0) scale(1); }
        }
        @keyframes fanDiscoverGradientShift {
          0% { background-position: 0% 50%; }
          50% { background-position: 100% 50%; }
          100% { background-position: 0% 50%; }
        }
        @keyframes fanDiscoverShimmer {
          0% { background-position: -200% 0; }
          100% { background-position: 200% 0; }
        }
        @keyframes fanDiscoverPulseDot {
          0%, 100% { opacity: 1; transform: scale(1); }
          50% { opacity: 0.4; transform: scale(1.4); }
        }
        @keyframes fanDiscoverImageReveal {
      ...
      <div style={{
        ...
        <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', overflow: 'hidden', zIndex: 0 }}>
          <div style={{
            ...
            borderRadius: '50%', animation: 'fanDiscoverFloatOrb 10s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', top: '40%', left: '-100px',
            width: '400px', height: '400px',
            background: 'radial-gradient(circle, rgba(168,85,247,0.04) 0%, transparent 70%)',
            borderRadius: '50%', animation: 'fanDiscoverFloatOrb2 13s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', bottom: '-60px', right: '30%',
            width: '350px', height: '350px',
            background: 'radial-gradient(circle, rgba(244,114,182,0.03) 0%, transparent 70%)',
            borderRadius: '50%', animation: 'fanDiscoverFloatOrb3 16s ease-in-out infinite',
          }} />
          <div style={{
        ...
        <div style={{
          ...
          animation: 'fanDiscoverFadeInDown 0.5s ease-out',
        }}>
          <div style={{
            padding: '28px 32px', maxWidth: '1400px', margin: '0 auto',
            ...
            {songs.length > 0 && (
              <div style={{
                ...
                <div style={{
                  ...
                  background: '#f472b6', boxShadow: '0 0 8px rgba(244,114,182,0.5)',
                  animation: 'fanDiscoverPulseDot 2s ease-in-out infinite',
                }} />
        ...
        <div style={{
          ...
          {songs.length === 0 ? (
            <div style={{
              ...
              animation: 'fanDiscoverFadeInUp 0.6s ease-out',
            }}>
              <div style={{
              ...
              <p style={{ fontSize: '13px', color: '#3f3f46', margin: 0 }}>
                Active artist campaigns will appear here
              </p>
            </div>
          ) : (
            <div style={{
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      animation: isHovered ? 'fanDiscoverGradientShift 2s ease-in-out infinite' : 'none',
                    ...
                    <div style={{
                      ...
                      {song.coverArtUrl ? (
                        <img
                          ...
                          style={{
                            ...
                            animation: 'fanDiscoverImageReveal 0.5s ease-out',
                          }}
                        />
                      ) : (
                        <div style={{
                      ...
                      <div style={{
                        ...
                        background: 'linear-gradient(to top, rgba(6,6,10,0.85) 0%, transparent 100%)',
                        opacity: isHovered ? 1 : 0,
                      ...
                      {isHovered && (
                        <div style={{
                          ...
                          animation: 'fanDiscoverFadeInUp 0.2s ease-out',
                        }}>
                          ✦ Invest Now
                        </div>
                      )}
                    ...
                    <div style={{ padding: '20px' }}>
                      <div style={{ marginBottom: '16px' }}>
                        ...
                        <p style={{
                          fontSize: '13px', color: '#71717a', margin: 0, fontWeight: 500,
                          overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
                        }}>
                      ...
                      <div>
                        <div style={{
                          ...
                          <div>
                            ...
                            <p style={{
                              fontSize: '16px', fontWeight: 800, color: '#f472b6', margin: 0,
                              textShadow: isHovered ? '0 0 12px rgba(244,114,182,0.3)' : 'none',
                          ...
                          <div style={{ textAlign: 'right' }}>
                            ...
                            <p style={{
                              fontSize: '13px', fontWeight: 600, color: '#71717a', margin: 0,
                            }}>
                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            animation: isHovered ? 'fanDiscoverGradientShift 2s ease-in-out infinite' : 'none',
                            borderRadius: '3px',
                            boxShadow: isHovered ? '0 0 10px rgba(236,72,153,0.4)' : 'none',
                          ...
                          {isHovered && (
                            <div style={{
                              ...
                              backgroundSize: '200% 100%',
                              animation: 'fanDiscoverShimmer 1.5s linear infinite',
                            }} />
                          )}
                        </div>
                        ...
                        <div style={{
                          ...
                          <span style={{
                            ...
                            color: progress >= 100 ? '#f472b6' : '#52525b',
                          }}>
