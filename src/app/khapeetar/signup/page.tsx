  ...
  return (
    <>
      <style jsx global>{`
        ...
        .signup-scrollbar::-webkit-scrollbar {
          width: 5px;
        }
        .signup-scrollbar::-webkit-scrollbar-track {
          background: transparent;
        }
        .signup-scrollbar::-webkit-scrollbar-thumb {
      ...
      <div style={{
        ...
        <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', overflow: 'hidden', zIndex: 0 }}>
          <div style={{
            ...
            borderRadius: '50%', animation: 'floatOrb 12s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', bottom: '5%', right: '5%',
            width: '400px', height: '400px',
            background: 'radial-gradient(circle, rgba(20,184,166,0.05) 0%, transparent 70%)',
            borderRadius: '50%', animation: 'floatOrb2 15s ease-in-out infinite',
          }} />
          <div style={{
            position: 'absolute', top: '40%', right: '20%',
            width: '300px', height: '300px',
            background: 'radial-gradient(circle, rgba(52,211,153,0.04) 0%, transparent 70%)',
            borderRadius: '50%', animation: 'floatOrb3 18s ease-in-out infinite',
          }} />
          <div style={{
        ...
        <nav style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <Link
              href="/khapeetar/login"
              onMouseEnter={() => setHovered('signin')}
              onMouseLeave={() => setHovered(null)}
              style={{
                fontSize: '12px', fontWeight: 600,
                color: hovered === 'signin' ? '#6ee7b7' : '#34d399',
                textDecoration: 'none',
                padding: '6px 14px',
                borderRadius: '10px',
                background: hovered === 'signin' ? 'rgba(16,185,129,0.08)' : 'transparent',
        ...
        {/* Main */}
        <div className="signup-scrollbar" style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0', marginBottom: '20px' }}>
                {STEPS.map((label, idx) => {
                  ...
                  return (
                    <div key={label} style={{
                      display: 'flex', alignItems: 'center', flex: idx < STEPS.length - 1 ? 1 : 'none',
                    }}>
                      <div style={{
                      ...
                      >
                        <div style={{
                          ...
                          border: `1.5px solid ${done ? 'rgba(16,185,129,0.4)' : active ? 'rgba(16,185,129,0.5)' : 'rgba(255,255,255,0.06)'}`,
                          color: done ? '#34d399' : active ? '#34d399' : '#52525b',
                          transition: 'all 0.3s ease',
                        ...
                        <span style={{
                          ...
                          color: active ? '#fff' : done ? '#34d399' : '#3f3f46',
                          whiteSpace: 'nowrap',
                          transition: 'color 0.3s ease',
                      ...
                      {idx < STEPS.length - 1 && (
                        <div style={{
                          ...
                          <div style={{
                            ...
                            boxShadow: done ? '0 0 8px rgba(16,185,129,0.3)' : 'none',
                          }} />
                        </div>
                      )}
                    </div>
                ...
                {step === 1 && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    <div style={{ marginBottom: '4px' }}>
                      <h2 style={{
                        fontSize: '20px', fontWeight: 800, margin: '0 0 4px 0',
                        background: 'linear-gradient(135deg, #fff 0%, #a1a1aa 100%)',
                        WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
                      }}>Basic Information</h2>
                      <p style={{ fontSize: '13px', color: '#52525b', margin: 0, fontWeight: 500 }}>
                        Let artists know who you are
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div style={{ position: 'relative' }}>
                        {focused === 'password' && (
                          <div style={{
                            position: 'absolute', inset: '-1px', borderRadius: '15px',
                        ...
                        <input
                          ...
                          onBlur={() => setFocused(null)}
                          placeholder="••••••••"
                          style={{ ...inputStyle('password'), paddingRight: '48px', position: 'relative' as const }}
                        />
                        <button
                          type="button"
                      ...
                      {form.password.length > 0 && (
                        <div style={{ marginTop: '10px' }}>
                          ...
                          <p style={{
                            ...
                            color: form.password.length >= 8 ? '#34d399' : '#fbbf24',
                            fontWeight: 500,
                          }}>
                    ...
                    <div>
                      <label style={labelStyle('phone')}>Phone <span style={{ color: '#3f3f46' }}>(optional)</span></label>
                      <input
                        type="tel"
                        value={form.phone}
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div>
                          ...
                          return (
                            <button
                              ...
                              style={{
                                ...
                                fontSize: '12px',
                                fontWeight: 600,
                                border: `1px solid ${selected ? 'rgba(16,185,129,0.4)' : hovered === `skill-${skill}` ? 'rgba(255,255,255,0.15)' : 'rgba(255,255,255,0.06)'}`,
                                background: selected
                                ...
                                fontFamily: 'inherit',
                                transform: hovered === `skill-${skill}` ? 'translateY(-1px)' : 'translateY(0)',
                                boxShadow: selected ? '0 2px 12px rgba(16,185,129,0.1)' : 'none',
                              }}
                            >
                              {selected && '✓ '}{skill}
                            </button>
                      ...
                      {form.skills.length > 0 && (
                        <p style={{
                          fontSize: '11px', color: '#34d399', marginTop: '10px', fontWeight: 600,
                        }}>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onFocus={() => setFocused('primaryRole')}
                        onBlur={() => setFocused(null)}
                        style={{
                          ...inputStyle('primaryRole'),
                          cursor: 'pointer',
                        }}
                      >
                        ...
                        {WORK_MODES.map(mode => {
                          ...
                          return (
                            <button
                              ...
                              onMouseEnter={() => setHovered(`wm-${mode}`)}
                              onMouseLeave={() => setHovered(null)}
                              style={{
                                padding: '14px',
                                borderRadius: '14px',
                                ...
                                background: sel
                                  ...
                                  : hovered === `wm-${mode}` ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.02)',
                                color: sel ? '#34d399' : '#71717a',
                                cursor: 'pointer',
                                transition: 'all 0.3s ease',
                                fontFamily: 'inherit',
                                boxShadow: sel ? '0 2px 16px rgba(16,185,129,0.1)' : 'none',
                                transform: hovered === `wm-${mode}` ? 'translateY(-1px)' : 'translateY(0)',
                              }}
                            >
                          ...
                          return (
                            <button
                              ...
                              style={{
                                ...
                                background: sel
                                  ? 'linear-gradient(135deg, rgba(16,185,129,0.12), rgba(20,184,166,0.08))'
                                  : hovered === `av-${a}` ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.02)',
                                color: sel ? '#34d399' : '#71717a',
                                cursor: 'pointer',
                                transition: 'all 0.3s ease',
                                fontFamily: 'inherit',
                                boxShadow: sel ? '0 2px 16px rgba(16,185,129,0.1)' : 'none',
                                transform: hovered === `av-${a}` ? 'translateY(-1px)' : 'translateY(0)',
                              }}
                            >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                      ...
                      <div>
                        ...
                        <div style={{ position: 'relative' }}>
                          <span style={{
                            ...
                            color: '#52525b', fontSize: '14px', fontWeight: 600,
                          }}>₹</span>
                          <input
                            type="number"
                            ...
                            onBlur={() => setFocused(null)}
                            placeholder="1500"
                            style={{ ...inputStyle('budget'), paddingLeft: '32px' }}
                          />
                        </div>
                      </div>
                      <div>
                    ...
                    <div>
                      <label style={labelStyle('bio')}>
                        Bio / Portfolio Description <span style={{ color: '#ef4444' }}>*</span>
                      </label>
                      <textarea
                        value={form.bio}
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          <div style={{
                            height: '100%',
                            width: `${Math.min(100, (form.bio.length / 200) * 100)}%`,
                            background: 'linear-gradient(90deg, #10b981, #14b8a6)',
                            borderRadius: '1px',
                        ...
                        <span style={{
                          fontSize: '11px', color: '#3f3f46', fontWeight: 500, flexShrink: 0,
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                      <div>
                        <label style={labelStyle('insta')}>
                          Instagram <span style={{ color: '#3f3f46' }}>(optional)</span>
                        </label>
                        <input
                          ...
                          style={inputStyle('insta')}
                        />
                      </div>
                      <div>
                        <label style={labelStyle('yt')}>
                          YouTube <span style={{ color: '#3f3f46' }}>(optional)</span>
                        </label>
                        <input
                          value={form.youtube}
                          onChange={e => update('youtube', e.target.value)}
                          onFocus={() => setFocused('yt')}
                          onBlur={() => setFocused(null)}
                    ...
                    <div>
                      <label style={labelStyle('spotify')}>
                        Spotify Credits <span style={{ color: '#3f3f46' }}>(optional)</span>
                      </label>
                      <input
                        value={form.spotifyCredits}
                        onChange={e => update('spotifyCredits', e.target.value)}
                        onFocus={() => setFocused('spotify')}
                        onBlur={() => setFocused(null)}
                        placeholder="Songs you've worked on..."
                        style={inputStyle('spotify')}
                      />
                    </div>
            ...
            <div style={{
              ...
              <button
                ...
                disabled={step === 1}
                onMouseEnter={() => step > 1 && setHovered('back')}
                onMouseLeave={() => setHovered(null)}
                style={{
                  display: 'flex', alignItems: 'center', gap: '8px',
                  padding: '12px 22px',
                  background: hovered === 'back' ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.03)',
                  border: `1px solid ${hovered === 'back' ? 'rgba(255,255,255,0.12)' : 'rgba(255,255,255,0.06)'}`,
                  borderRadius: '14px',
                  color: step === 1 ? '#27272a' : hovered === 'back' ? '#fff' : '#71717a',
              ...
              {step < STEPS.length ? (
                <button
                  ...
                  onClick={() => setStep(s => s + 1)}
                  disabled={!canProceed()}
                  onMouseEnter={() => canProceed() && setHovered('next')}
                  onMouseLeave={() => setHovered(null)}
                  style={{
                    display: 'flex', alignItems: 'center', gap: '8px',
                    padding: '12px 22px',
                    background: !canProceed() ? 'rgba(255,255,255,0.03)' : 'linear-gradient(135deg, #10b981, #14b8a6)',
                    border: 'none',
                    borderRadius: '14px',
                    ...
                    transform: hovered === 'next' ? 'translateX(2px)' : 'translateX(0)',
                    boxShadow: hovered === 'next' && canProceed()
                      ? '0 6px 30px rgba(16,185,129,0.3)'
                      : canProceed() ? '0 2px 16px rgba(16,185,129,0.15)' : 'none',
                    overflow: 'hidden',
                    position: 'relative' as const,
                  }}
                >
                  {hovered === 'next' && canProceed() && (
                    <div style={{
                      position: 'absolute', inset: 0,
                ...
                <button
                  ...
                  onMouseEnter={() => canProceed() && !submitting && setHovered('submit')}
                  onMouseLeave={() => setHovered(null)}
                  style={{
                    display: 'flex', alignItems: 'center', gap: '8px',
                    padding: '12px 26px',
                    ...
                    border: 'none',
                    borderRadius: '14px',
                    color: (!canProceed() || submitting) ? '#3f3f46' : '#fff',
                    fontSize: '13px', fontWeight: 700,
                    cursor: (!canProceed() || submitting) ? 'not-allowed' : 'pointer',
                    transition: 'all 0.3s cubic-bezier(0.4,0,0.2,1)',
                    fontFamily: 'inherit',
                    opacity: (!canProceed() || submitting) ? 0.4 : 1,
                    transform: hovered === 'submit' ? 'translateY(-2px)' : 'translateY(0)',
                    boxShadow: hovered === 'submit'
                ...
                >
                  ...
                  {submitting ? (
                    <>
                      ...
                      <span style={{ position: 'relative' }}>Creating Account...</span>
                    </>
                  ) : (
            ...
            <div style={{ textAlign: 'center' }}>
              <p style={{ fontSize: '13px', color: '#3f3f46', margin: 0, fontWeight: 500 }}>
                ...
                <Link
                  href="/khapeetar/login"
                  onMouseEnter={() => setHovered('login-link')}
                  onMouseLeave={() => setHovered(null)}
                  style={{
                    color: hovered === 'login-link' ? '#6ee7b7' : '#34d399',
                    textDecoration: 'none', fontWeight: 600,
                    borderBottom: `1px solid ${hovered === 'login-link' ? 'rgba(110,231,183,0.4)' : 'transparent'}`,
                    paddingBottom: '1px',
            ...
            <div style={{
              ...
              {[
                ...
                { icon: '🛡️', text: 'Verified Platform' },
              ].map((badge, i) => (
                <div key={i} style={{
                  display: 'flex', alignItems: 'center', gap: '6px',
                  fontSize: '11px', color: '#27272a', fontWeight: 500,
                }}>
