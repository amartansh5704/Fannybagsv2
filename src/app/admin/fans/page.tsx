    ...
    <AdminLayout>
      ...
      <div style={{
        ...
        <div style={{
          ...
          animation:'afFadeInDown 0.5s ease-out',
        }}>
          <div style={{padding:'28px 32px',maxWidth:'1200px',margin:'0 auto',display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:'16px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'14px'}}>
              <div style={{
                ...
                background:'linear-gradient(135deg,rgba(236,72,153,0.14),rgba(244,114,182,0.10))',
              ...
              <div>
                ...
                <p style={{fontSize:'13px',color:'#52525b',margin:'2px 0 0 0',fontWeight:500}}>
                  Manage registered fan accounts
                </p>
              </div>
            </div>
            ...
            <div style={{display:'flex',alignItems:'center',gap:'12px',flexWrap:'wrap'}}>
              ...
              <div style={{position:'relative'}}>
                ...
                <input
                  ...
                  style={{
                    ...
                    border:`1px solid ${focused ? 'rgba(236,72,153,0.5)' : 'rgba(255,255,255,0.07)'}`,
              ...
              <div style={{
                ...
                <span style={{fontSize:'12px',fontWeight:700,color:'#f472b6'}}>
                  {filtered.length} fan{filtered.length !== 1 ? 's' : ''}
                </span>
              </div>
            </div>
          </div>
        ...
        <div style={{position:'relative',zIndex:1,padding:'28px 32px 48px',maxWidth:'1200px',margin:'0 auto'}}>
          {filtered.length === 0 ? (
            <div style={{
              ...
              padding:'100px 0',animation:'afFadeInUp 0.6s ease-out',
            }}>
              ...
              <p style={{fontSize:'16px',fontWeight:600,color:'#52525b',margin:'0 0 4px 0'}}>
                {searchQuery ? 'No matching fans' : 'No fans yet'}
              </p>
              <p style={{fontSize:'13px',color:'#3f3f46',margin:0}}>
                {searchQuery ? 'Try a different search term' : 'Registered fans will appear here'}
              </p>
            </div>
          ) : (
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      animation:`afFadeInStagger 0.4s ease-out ${index * 0.05}s both`,
                    }}
                  >
                    {/* Left accent */}
                    <div style={{
